...
* :class:`~crucible.models.ollama_adapter.OllamaModel` — a local model served by
  Ollama on the RTX 5090 (the cross-family panel members, §8.6 / §11.2).
* :class:`~crucible.models.claude_adapter.ClaudeModel` — Claude via the Anthropic
...
:class:`~crucible.characterize.types.JudgmentRecord` for the §11.1 admission test) —
...
from crucible.models.claude_adapter import ClaudeModel
