...
**Yes — self-referential/intrinsic competition is the stronger engagement frame, on both capability and safety grounds.** Social peer-standings carry the documented downside of social/ego-orientation plus the task-irrelevant-cue degradation AI Crucible is avoiding; self-referenced framing carries upside on real performance (finding 9) *and* maps 1:1 onto the most validated capability-raising machinery (SPIN, R-Zero, Reflexion). The one genuine hazard — self-evaluation reward-hacking (findings 6, 7) — is orthogonal to the framing and is neutralized by AI Crucible's existing EXTERNAL_VERIFIER + ANDON standards.
